    ...
    <div className="appContainer">
      <div className="heroSection">
        <div className="mainArea">
          ...
          {unitType === "metric" ?
            <div className="metricInputFormContainerBox">
            ...
            :
            <div className="imperialInputFormContainerBox">
      ...
      <div className="secondSection">
        <div className="sSMainImageContainer">
      ...
      <div className="limitationsSectionBox">
      <div className="limitationsSection">
        ...
        <div className="muscle-pregnancy">
